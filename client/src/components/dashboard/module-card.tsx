    ...
    >
      {compact ? (
        <div className="flex flex-col items-center text-center space-y-1 sm:space-y-2">
          <div className={cn(
            "rounded-lg flex items-center justify-center module-icon transition-colors relative",
        ...
        <div className="flex items-center space-x-3">
          <div className="w-12 h-12 rounded-lg flex items-center justify-center module-icon transition-colors relative">
